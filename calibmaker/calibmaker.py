...
VBG_ADJ = 1 # Lower Bound: 4
DVTH = 100#Lower Bound: 65
...
changeCH("DVOFFSET",223,ch=1)
changeCH("DVOFFSET",203,ch=2)
changeCH("DVOFFSET",200,ch=3)
changeCH("DVOFFSET",202,ch=4)
changeCH("DVOFFSET",207,ch=5)
changeCH("DVOFFSET",219,ch=6)
changeCH("DVOFFSET",210,ch=7)
changeCH("DVOFFSET",214,ch=8)
